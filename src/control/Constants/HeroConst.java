...
public interface HeroConst {
    ...
    public static final String PALADIN_RES_PATH = "P"; //CHARACTERS_PATH + "paladin.";
    ...
    public static final String MAGE_RES_PATH = "M";//CHARACTERS_PATH + "mage.";
    ...
    public static final String ASSASSIN_RES_PATH = "A"; //CHARACTERS_PATH + "assassin.";
    ...
    public static final String RANGER_RES_PATH = "R"; //CHARACTERS_PATH + "ranger.";
